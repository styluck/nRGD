function M = restrictedstiefelfactory(n, p, k)
...
%     end
    ...
    function rhess = ehess2rhess(X, egrad, ehess, H)
        ...
        egrad = egrad - repmat(sum(egrad),n,1)/n;
    ...
    function Y = retraction_polar(X, U, t)
        ...
        Y = X + t*U;
        [U, SIGMA, S] = svd(Y'*Y);   SIGMA =diag(SIGMA);    Y = Y*(U*diag(sqrt(1./SIGMA))*S');
    end
